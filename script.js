...
async function deleteServer(id) {
  ...
  try {
    const res = await fetch(`https://api-green-iota.vercel.app/api/server/${id}`, {
      method: "DELETE"
    });
...
async function fetchAdmins() {
  ...
  try {
    const res = await fetch("https://api-green-iota.vercel.app/api/admins");
...
async function deleteAdmin(id) {
  ...
  try {
    const res = await fetch(`https://api-green-iota.vercel.app/api/admin/${id}`, {
      method: "DELETE"
    });
