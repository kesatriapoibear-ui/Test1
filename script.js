...
// Typing animation
const texts = ["Auto Panel Creator", "Pterodactyl API", "Neko Host", "Server Management"];
let textIndex = 0;
let charIndex = 0;
...
async function handlePanelSubmit(e) {
  ...
  try {
    const res = await fetch("http://alifserver.privateserverr.my.id:2585/create", {
      method: "POST",
...
async function handleAdminSubmit(e) {
  ...
  try {
    const res = await fetch("http://alifserver.privateserverr.my.id:2585/create-admin", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
...
async function fetchServers() {
  ...
  try {
    const res = await fetch("http://alifserver.privateserverr.my.id:2585/servers");
...
async function deleteServer(id) {
  ...
  try {
    const res = await fetch(`http://alifserver.privateserverr.my.id:2585/server/${id}`, {
      method: "DELETE"
    });
...
async function fetchAdmins() {
  ...
  try {
    const res = await fetch("http://alifserver.privateserverr.my.id:2585/admins");
...
async function deleteAdmin(id) {
  ...
  try {
    const res = await fetch(`http://alifserver.privateserverr.my.id:2585/admin/${id}`, {
      method: "DELETE"
    });
